...
/* harmony import */ var _modules_header_init_header_fix__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/header/init-header-fix */ "./js/modules/header/init-header-fix.js");
/* harmony import */ var _modules_header_get_header_height__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header/get-header-height */ "./js/modules/header/get-header-height.js");
...
/* harmony import */ var _modules_parallax_set_parallax_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/parallax/set-parallax.js */ "./js/modules/parallax/set-parallax.js");
/* harmony import */ var _modules_service_list_show_learn_more_btn_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/service-list/show-learn-more-btn.js */ "./js/modules/service-list/show-learn-more-btn.js");
/* harmony import */ var _modules_accordion_init_accordion_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/accordion/init-accordion.js */ "./js/modules/accordion/init-accordion.js");
/* harmony import */ var _modules_video_set_custom_video_control_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/video/set-custom-video-control.js */ "./js/modules/video/set-custom-video-control.js");
/* harmony import */ var _modules_video_change_poster_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/video/change-poster.js */ "./js/modules/video/change-poster.js");
/* harmony import */ var _modules_lifting_by_scroll_set_lifting_by_scroll_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/lifting-by-scroll/set-lifting-by-scroll.js */ "./js/modules/lifting-by-scroll/set-lifting-by-scroll.js");
/* harmony import */ var _modules_lifting_by_scroll_set_top_block_lifting_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/lifting-by-scroll/set-top-block-lifting.js */ "./js/modules/lifting-by-scroll/set-top-block-lifting.js");
/* harmony import */ var _modules_pricing_set_pricing_padding_bottom_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/pricing/set-pricing-padding-bottom.js */ "./js/modules/pricing/set-pricing-padding-bottom.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header_init_header_fix__WEBPACK_IMPORTED_MODULE_2__["initHeaderFix"])();
  Object(_modules_header_get_header_height__WEBPACK_IMPORTED_MODULE_3__["getHeaderHeight"])();
  Object(_modules_parallax_set_parallax_js__WEBPACK_IMPORTED_MODULE_5__["setParallax"])();
  Object(_modules_service_list_show_learn_more_btn_js__WEBPACK_IMPORTED_MODULE_6__["showLearnMoreButton"])();
  Object(_modules_video_set_custom_video_control_js__WEBPACK_IMPORTED_MODULE_8__["setCustomVideoControl"])();
  Object(_modules_video_change_poster_js__WEBPACK_IMPORTED_MODULE_9__["changeVideoPoster"])();
  Object(_modules_pricing_set_pricing_padding_bottom_js__WEBPACK_IMPORTED_MODULE_12__["setPricingPaddingBottom"])();
  Object(_modules_lifting_by_scroll_set_lifting_by_scroll_js__WEBPACK_IMPORTED_MODULE_10__["generateTimeline"])();
  Object(_modules_lifting_by_scroll_set_top_block_lifting_js__WEBPACK_IMPORTED_MODULE_11__["setTopBlockLifting"])();
  ...
  window.addEventListener('load', function () {
    Object(_modules_accordion_init_accordion_js__WEBPACK_IMPORTED_MODULE_7__["initAccordions"])();
...
/* harmony import */ var _form_submit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-submit */ "./js/modules/form-validate/form-submit.js");

var baseSuccessCallback = function baseSuccessCallback(event) {
  event.preventDefault();
  // В данном колбеке бэкендер, либо разработчик при необходимости будет писать запрос на отправку формы на сервер и обрабатывать возможные ошибки или успешную отправку формы на сервер
  Object(_form_submit__WEBPACK_IMPORTED_MODULE_0__["showSuccesFubmitFormMessage"])();
};
...
/***/ "./js/modules/form-validate/form-submit.js":
/*!*************************************************!*\
  !*** ./js/modules/form-validate/form-submit.js ***!
  \*************************************************/
/*! exports provided: showSuccesFubmitFormMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showSuccesFubmitFormMessage", function() { return showSuccesFubmitFormMessage; });
var showSuccesFubmitFormMessage = function showSuccesFubmitFormMessage() {
  var subscribeForm = document.getElementById('subscribe-form');
  var successMessageElement = subscribeForm.querySelector('.subscribe-form__success-message');
  var emailInputElement = subscribeForm.querySelector('.subscribe-form__input-box');
  var removeMessage = function removeMessage() {
    successMessageElement.classList.add('subscribe-form__success-message--hidden');
    setTimeout(function () {
      return emailInputElement.classList.remove('subscribe-form__input-box--hidden');
    }, 300);
  };
...
var Burger = /*#__PURE__*/function () {
  function Burger() {
    ...
    this._scrollLock = _vendor_scroll_lock__WEBPACK_IMPORTED_MODULE_0___default.a;
...
/***/ "./js/modules/header/get-header-height.js":
/*!************************************************!*\
  !*** ./js/modules/header/get-header-height.js ***!
  \************************************************/
...
var getHeaderHeight = function getHeaderHeight() {
  ...
  var headerHeightCalc = function headerHeightCalc() {
    var headerHeightValue = "".concat(header.offsetHeight, "px");
    document.documentElement.style.setProperty('--header-height', headerHeightValue);
  };
  headerHeightCalc();
  var headerHeightCalcOnResize = Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["debounce"])(function () {
    return headerHeightCalc();
  });
...
/***/ "./js/modules/header/init-header-fix.js":
/*!**********************************************!*\
  !*** ./js/modules/header/init-header-fix.js ***!
  \**********************************************/
/*! exports provided: initHeaderFix */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHeaderFix", function() { return initHeaderFix; });
var header = document.querySelector('.header');
var initHeaderFix = function initHeaderFix() {
  if (!header) {
    return;
  }
...
/***/ "./js/modules/lifting-by-scroll/set-lifting-by-scroll.js":
/*!***************************************************************!*\
  !*** ./js/modules/lifting-by-scroll/set-lifting-by-scroll.js ***!
  \***************************************************************/
/*! exports provided: generateTimeline */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateTimeline", function() { return generateTimeline; });
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../vendor/gsap.min.js */ "./js/vendor/gsap.min.js");
...
/* harmony import */ var _vendor_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../vendor/ScrollTrigger.min.js */ "./js/vendor/ScrollTrigger.min.js");
...
_vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(_vendor_ScrollTrigger_min_js__WEBPACK_IMPORTED_MODULE_1__["ScrollTrigger"]);
...
var generateTimeline = function generateTimeline() {
  ...
  sections.forEach(function (section) {
    var blocks = _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray(section.querySelectorAll("[data-animation]")).sort(function (a, b) {
...
/***/ "./js/modules/lifting-by-scroll/set-top-block-lifting.js":
/*!***************************************************************!*\
  !*** ./js/modules/lifting-by-scroll/set-top-block-lifting.js ***!
  \***************************************************************/
/*! exports provided: setTopBlockLifting */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setTopBlockLifting", function() { return setTopBlockLifting; });
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../vendor/gsap.min.js */ "./js/vendor/gsap.min.js");
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__);

var liftingBlocks = document.querySelectorAll('[data-top-block]');
var setTopBlockLifting = function setTopBlockLifting() {
  if (!liftingBlocks) {
    return;
  }
  var tl = _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline();
  liftingBlocks.forEach(function (block) {
    tl.to(block, {
      y: 0,
      opacity: 1,
      duration: 2
...
/***/ "./js/modules/parallax/set-parallax.js":
/*!*********************************************!*\
  !*** ./js/modules/parallax/set-parallax.js ***!
  \*********************************************/
/*! exports provided: setParallax */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setParallax", function() { return setParallax; });
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../vendor/gsap.min.js */ "./js/vendor/gsap.min.js");
/* harmony import */ var _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__);

var parallaxItems = document.querySelectorAll('[data-parallax-mouse]');
var parallaxElements = document.querySelectorAll('[data-parallax-box]');
var mouseCords = {
  x: 0,
  y: 0
...
var updateParallax = function updateParallax() {
  parallaxItems.forEach(function (item) {
    if (window.matchMedia('(min-width: 768px)').matches) {
      ...
      _vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(item, {
...
_vendor_gsap_min_js__WEBPACK_IMPORTED_MODULE_0__["gsap"].ticker.add(updateParallax); // вместо нового requestAnimationFrame используем rAF гсапа
...
/***/ "./js/modules/pricing/set-pricing-padding-bottom.js":
/*!**********************************************************!*\
  !*** ./js/modules/pricing/set-pricing-padding-bottom.js ***!
  \**********************************************************/
/*! exports provided: setPricingPaddingBottom */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setPricingPaddingBottom", function() { return setPricingPaddingBottom; });
/* harmony import */ var _utils_debounce__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/debounce */ "./js/utils/debounce.js");

var pricing = document.querySelector('.pricing');
var setPricingPaddingBottom = function setPricingPaddingBottom() {
  if (!pricing) {
    return;
  }
  var pricingInner = pricing.querySelector('.pricing__inner');
  var pricingPaddingBottomCalc = function pricingPaddingBottomCalc() {
    if (window.matchMedia('(max-width: 429px)').matches) {
      return;
    }
    var pricingContentBoxBottomX = pricing.querySelector('.pricing__content-wrapper').getBoundingClientRect().bottom;
    var offerBoxBottomX = pricing.querySelector('.pricing__offer').getBoundingClientRect().bottom;
    var pricingPaddingBottomValue = "".concat(Math.round(offerBoxBottomX - pricingContentBoxBottomX), "px");
  ...
  var pricingPaddingBottomCalcOnResize = Object(_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["debounce"])(function () {
    return pricingPaddingBottomCalc();
  });
...
/***/ "./js/modules/service-list/show-learn-more-btn.js":
/*!********************************************************!*\
  !*** ./js/modules/service-list/show-learn-more-btn.js ***!
  \********************************************************/
/*! exports provided: showLearnMoreButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showLearnMoreButton", function() { return showLearnMoreButton; });
var serviceLists = document.querySelectorAll('.services__list--cards');
var showLearnMoreButton = function showLearnMoreButton() {
  if (!serviceLists) {
    return;
  }
  var serviceCards = document.querySelectorAll('.services__item--card');
  var activeServiceCardTogle = function activeServiceCardTogle(card, evt) {
    var target = evt.target;
...
/***/ "./js/modules/video/change-poster.js":
/*!*******************************************!*\
  !*** ./js/modules/video/change-poster.js ***!
  \*******************************************/
/*! exports provided: changeVideoPoster */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeVideoPoster", function() { return changeVideoPoster; });
var videoSection = document.querySelector('.video');
var changeVideoPoster = function changeVideoPoster() {
  if (!videoSection) {
    return;
  }
  var video = videoSection.querySelector('.video__content');
  var mobileWidth = window.matchMedia('(max-width: 768px)');
  var videoPosterToggle = function videoPosterToggle() {
    return mobileWidth.matches ? video.setAttribute('poster', 'img/content/video-poster-mobile.webp') : video.setAttribute('poster', 'img/content/video-poster.webp');
  };
...
/***/ "./js/modules/video/set-custom-video-control.js":
/*!******************************************************!*\
  !*** ./js/modules/video/set-custom-video-control.js ***!
  \******************************************************/
/*! exports provided: setCustomVideoControl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setCustomVideoControl", function() { return setCustomVideoControl; });
var videoSection = document.querySelector('.video');
var setCustomVideoControl = function setCustomVideoControl() {
  if (!videoSection) {
    return;
  }
  var video = videoSection.querySelector('.video__content');
  var mainPlayButton = videoSection.querySelector('.video__main-play-btn');
  var playPauseButton = videoSection.querySelector('.video__play-btn');
  var seekBar = videoSection.querySelector('.video__seek-bar');
  var videoInfo = videoSection.querySelector('.video__info-box');
  var resetVideoControl = function resetVideoControl() {
    seekBar.value = 0;
  ...
  var onPlayBtnClick = function onPlayBtnClick() {
    return video.paused === true ? videoPlay() : videoPause();
  };
